...
// sound-tap question lines ("ตัวไหนร้อง ... นะ?") for its cast -- must match the exact string passed to speak()
...
// scratch & reveal scene names ("... ไงจ๊ะ")
["ไดโนเสาร์","ใต้ทะเล","อวกาศ","ป่าใหญ่","ฟาร์ม"].forEach(n => add(out.th, n + " ไงจ๊ะ"));

// car-shop paint swatch names (color words spoken when a bucket is tapped)
["สีแดง","สีส้ม","สีเหลือง","สีเขียว","สีฟ้า","สีน้ำเงิน","สีม่วง","สีชมพู","สีน้ำตาล","สีดำ","สีขาว"]
  .forEach(n => add(out.th, n));

// sorting game: garbage items + toy items (spoken by name when placed correctly)
[
  "ขวดแก้ว","กระป๋อง","กระดาษ","กล่องกระดาษ","ขวดพลาสติก","หนังสือพิมพ์",
  "เศษผลไม้","เปลือกกล้วย","เศษข้าว","เศษผัก","เศษอาหาร","เปลือกผลไม้",
  "พลาสเตอร์","ทิชชู่ใช้แล้ว","ถุงเท้าขาด","ดินสอหัก",
  "ตุ๊กตาหมี","รถของเล่น","ลูกบอล","โยโย่","จิ๊กซอว์","ลูกโป่ง",
  "ว่าว","ตัวต่อ","ลูกเต๋า","ตุ๊กตา",
].forEach(n => add(out.th, n));
